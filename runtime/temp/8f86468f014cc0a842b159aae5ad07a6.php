<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:29:"theme/portal/index/index.html";i:1527147088;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <script type="text/javascript" src="/static/more/js/modernizr.js"></script>
    <![endif]-->
    ...
    <link rel="stylesheet" type="text/css" href="/static/more/css/base.css"/>
    <link rel="stylesheet" type="text/css" href="/static/more/css/index.css"/>
    <link rel="stylesheet" type="text/css" href="/static/more/css/m.css"/>
...
<header>
    ...
    <!--mnav begin-->
    <div id="mnav">
        <h2><a href="http://www.cnit8.com" class="mlogo">博客</a><span class="navicon"></span></h2>
        <dl class="list_dl">
        ...
        <div class="banner">
            <div id="ban" class="fader">
                <li class="slide" >
                    ...
                    <img src="images/banner01.jpg"><span class="imginfo">别让这些闹心的套路，毁了你的网页设计!</span>
                    </a>
                </li>
...
<script src="/static/more/js/jquery.easyfader.min.js"></script>
<script src="/static/more/js/conn.js"></script>
<script src="/static/more/js/nav.js"></script>
<script src="/static/more/js/scrollReveal.js"></script>
</html>